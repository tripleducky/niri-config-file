...
Rectangle {
    ...
    property real volume: sink?.volume ?? 0
    property bool muted: sink?.muted ?? false
    ...
    RowLayout {
        ...
        Text {
            text: {
                ...
                console.log("Volume raw:", volume, "Type:", typeof volume);
                console.log("Sink:", sink, "Audio:", sink?.audio);
